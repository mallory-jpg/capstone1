...
# TODO https://fugue-tutorials.readthedocs.io/en/latest/tutorials/fugue_sql/syntax.html
...
class DataBase():
    ...
    def create_database(self, connection, query) -> None:
        """
    ...
    def execute_query(self, connection, query) -> None:
        """
    ...
    def read_query(self, connection, query) -> None:
        """
    ...
    def execute_mogrify(self, conn, df, table) -> None:
        """
