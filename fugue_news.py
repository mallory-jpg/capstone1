...
class News():
    ...
    # TODO pull out apply and map functions and add to fugue workflow context instead? 
    def get_all_news(self) -> pd.DataFrame:
        """Combine top headlines and popular news into one Pandas DataFrame."""
        try:
    ...
    def get_top_n(self, dict_elem, n) -> Iterable[List[Any]]: # TODO check type iterable 
        """
        Calculate most important keywords in text of interest
        :param dict_elem: dictionary of important words & their tf_idf_scores
        :param n: number of keywords of interest
        :return result: most important n words in descending order
        """
