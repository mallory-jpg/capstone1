...
This pipeline utilizes an ELT approach which extracts data from API calls, load it raw directly into Snowflake, then transforms the data for analysis in Python.
...
1. [x] Load results of a call to NewsAPI into Snowflake
